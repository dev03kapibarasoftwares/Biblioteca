...
{
    public abstract class TesteWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TesteWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TesteWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TesteDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TesteDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TesteDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TesteDbContext, Task<T>> func)
        {
            T result;
